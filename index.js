...
client.on('messageCreate', async message => {
  if (message.content.startsWith(prefix + 'stock')) {
    ...
    const embed = new MessageEmbed()
      ...
      .setImage('https://cdn.discordapp.com/attachments/1387473129311436984/1387474227946590331/54_20250515150043.png.jpg?ex=685d7991&is=685c2811&hm=51b2ddf582e273084bb3712c5805f4c7854e09a0a0d840732f4239ada4629c49&')
...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.commandName === 'setup') {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription('*لشراء أعضاء حقيقية، يرجى الضغط على الزر أدناه لفتح تذكره')
      .setColor(config.bot.colorembed)
      .setImage('https://cdn.discordapp.com/attachments/1387473129311436984/1387474308481421402/54_20250515150059.png.jpg?ex=685d79a5&is=685c2825&hm=8be273e7d00d3bb6c91dce20d3dd89518d1e5e255dee4a968e22db70d1ea349c&')
